...
namespace TsinghuaNet
{
    ...
    public static class MD5
    {
        ...
        */
        ...
        /// <summary>
        /// 将 <see cref="System.Collections.Generic.IEnumerable&lt;byte&gt;"/> 转换为16进制数的字符串。
        /// </summary>
        /// <param name="array">要转换的 <see cref="System.Collections.Generic.IEnumerable&lt;byte&gt;"/>。</param>
        /// <param name="uppercase">生成的字符串使用大写字母，则为 <c>true</c>，否则为 <c>false</c>。</param>
        /// <exception cref="ArgumentNullException"><paramref name="array"/> 为 <c>null</c>。</exception>
        public static string ToHexString(this IEnumerable<byte> array, bool uppercase)
        {
            if(array == null)
            ...
            {
                hexString += b.ToString(format, System.Globalization.CultureInfo.InvariantCulture);
            }
            return hexString;
        }

        /// <summary>
        /// 将 <see cref="IEnumerable{byte}"/> 转换为16进制数的字符串。
        /// </summary>
        /// <param name="array">要转换的 <see cref="IEnumerable{byte}"/>。</param>
        /// <exception cref="ArgumentNullException"><paramref name="array"/> 为 <c>null</c>。</exception>
        ...
        /// 计算指定字节数组的 MD5 值。
        /// </summary>
        /// <param name="input">给定的字节数组。</param>
        /// <returns>指定字节数组的 MD5 值。</returns>
        ...
        /// 计算给定字符串的 MD5 值。
        /// </summary>
        /// <param name="message">要计算的字符串。</param>
        /// <returns>给定字符串的 MD5 值。</returns>
